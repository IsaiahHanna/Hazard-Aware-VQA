...
def prepare_eval_dataset(df, path):
    """Specialized Phase 3 Loader: Handles Pathing and Multi-VRU JSON strings"""
    flat_data = []
    TARGET_SIZE = (640, 480)
    # Instruction remains the same as your proposal
    PROMPT_TEXT = (
        """
...
output in valid JSON format.
    ...
    for i, row in df.iterrows():
        ...
        # Reuse your existing GIF extraction logic
        ...
        # Build Ground Truth using CORRECT case-sensitivity (Risk, suggested_action)
        target_dict = {
    ...
    try:
        ...
        for key, value in res_json.items():
            if any(vru in key.lower() for vru in vru_keywords) and isinstance(value, dict):
                ...
                # --- FIXED: Handle both string and list outputs from model ---
